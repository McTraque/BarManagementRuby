class ProductTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_type.save
        format.html { redirect_to @product_type, notice: 'El tipo de producto se ha creado con éxito.' }
  ...
  def update
    respond_to do |format|
      if @product_type.update(product_type_params)
        format.html { redirect_to @product_type, notice: 'El tipo de producto se ha actualizado con éxito.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to product_types_url, notice: 'El tipo de producto se ha eliminado con éxito.' }
